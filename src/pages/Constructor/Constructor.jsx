...
import ConstructorNavBar from "../../components/ConstructorNavBar/ConstructorNavBar";
import LoginPopup from "../../components/LoginPopup/LoginPopup";

export default function Constructor() {
  const [value, setValue] = React.useState([]);
  const [modalActive, setModalActive] = useState(false) // вызов модального окна для логина
  ...
  return (<>
      <ConstructorNavBar setModalActive={setModalActive}/>
            ...
            <div className={styles.sideBarContent}>
              {
                ...
                <>
                  ...
                  <SidebarBlock kind={"form"} setContainerItems={setContainerItems} title={"Стандартная Форма"}
            ...
            <div className={styles.sideBarContent}>
              {
                value.includes("1") &&
                <>
                  <SidebarBlock setContainerItems={setContainerItems} kind={"nav"} title={"Стандартная навигация"}
